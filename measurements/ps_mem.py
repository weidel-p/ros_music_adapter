...
#
#
# Modified by: Philipp Weidel
# On 4th Nov. 2015:
# Modifed main funtion to plot a pie diagram using matplotlib and seaborn.
#
#
#
#
...
# CHANGED
            plt.pie([cmd[1] for cmd in sorted_cmds], labels=[str(cmd[0]) + "\n" + human(cmd[1]) for cmd in sorted_cmds], colors=palette, autopct='%1.1f%%', shadow=True, startangle=90)
