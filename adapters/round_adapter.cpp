...
main(int argc, char** argv)
{
  ...
  RoundAdapter round_adapter;
  round_adapter.init(argc, argv);
  round_adapter.runMUSIC();
  round_adapter.finalize();

}

void
RoundAdapter::init(int argc, char** argv)
{
...
void
RoundAdapter::initMUSIC(int argc, char** argv)
{
...
void 
RoundAdapter::runMUSIC()
{
  std::cout << "running round adapter" << std::endl;
